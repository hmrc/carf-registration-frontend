...
import pages.organisation.FirstContactPhoneNumberPage
...
object FirstContactPhoneNumberSummary {
  ...
  def row(answers: UserAnswers)(implicit messages: Messages): Option[SummaryListRow] =
    answers.get(FirstContactPhoneNumberPage).map { answer =>
      SummaryListRowViewModel(
        ...
        actions = Seq(
          ActionItemViewModel(
            ...
            href = routes.FirstContactPhoneNumberController.onPageLoad(ChangeMode).url
