...
class ChangeOrgSecondContactPhoneNumberControllerSpec extends SpecBase with MockitoSugar {
  ...
  val formProvider = new ChangeOrgSecondContactPhoneNumberFormProvider()
  ...
  lazy val changeOrgSecondContactPhoneNumberRoute = routes.ChangeOrgSecondContactPhoneNumberController.onPageLoad(NormalMode).url
  ...
  "ChangeOrgSecondContactPhoneNumber Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(ChangeOrgSecondContactPhoneNumberPage, validAnswer).success.value
