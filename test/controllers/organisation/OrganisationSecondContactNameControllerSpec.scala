...
class OrganisationSecondContactNameControllerSpec extends SpecBase {
  ...
  "OrganisationSecondContactName Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(OrganisationSecondContactNamePage, "answer").success.value
